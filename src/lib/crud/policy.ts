...
import { type PolicyContext, type PolicyResult } from "./types";
 ...
 */
export function canManageUsers(context: PolicyContext, targetUserId?: string): PolicyResult {
 ...
 */
export function canCreateBooking(context: PolicyContext, customerId?: string): PolicyResult {
 ...
 */
export function canViewBooking(context: PolicyContext, customerId: string): PolicyResult {
 ...
 */
export function canOverridePolicy(context: PolicyContext, scope: string): PolicyResult {
 ...
 */
export function canAccessPHI(context: PolicyContext, customerId: string): PolicyResult {
