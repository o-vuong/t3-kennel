...
const stepUpActionSchema = z.union([
	z.literal("issue_override_token"),
	z.literal("access_security_settings"),
	z.literal("process_refund"),
	z.literal("modify_user_roles"),
	z.literal("access_audit_logs"),
	z.literal("export_data"),
]);

const mfaMethodSchema = z.union([
	z.literal("totp"),
	z.literal("webauthn"),
	z.literal("recovery"),
]);
