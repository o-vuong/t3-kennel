...
export const careLogsRouter = createTRPCRouter({
  listByBooking: protectedProcedure.input(z.object({
    bookingId: z.string()
  })).query(({ ctx, input }) => {
  ...
  create: protectedProcedure.input(z.object({
    bookingId: z.string(),
    type: z.enum(["feeding", "medication", "exercise", "grooming", "medical"]),
    note: z.string(),
  })).mutation(({ ctx, input }) => {
  ...
  update: protectedProcedure.input(z.object({
    id: z.string(),
    type: z.enum(["feeding", "medication", "exercise", "grooming", "medical"]).optional(),
